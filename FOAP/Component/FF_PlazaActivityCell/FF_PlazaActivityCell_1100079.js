    ...
    render:function(){
        return (
            <View style={{backgroundColor:'#222222'}}>
                ...
                <View style={{height:44,flexDirection:'row',backgroundColor:'#000028'}}>
                    <Text style= {{fontSize:17,left:10,top:10,flex:1,color:'#FFFFFF'}}>
                        精彩后动</Text>
                    <TouchableHighlight  onPress={() => this.tappMore()}>
                        <View>
                            <Text style ={{top:15,color:'#FFFFFF'}}>
                                更多
                            </Text>
                            <Image>
                            </Image>
            ...
            <TouchableHighlight
                ...
                <View style = {{  height:(256.0 / 640 * windowWidth * 9 / 16) + 10,flexDirection:'row'}}>
                    ...
                    <View style={{left:10,alignItems:'center',flex:1,alignSelf:'center'}}>
                        <Text style = {{color:'#FFFFFF',fontSize:16,textAlign:'center',width:windowWidth - 256.0 / 640 * windowWidth - 15}}
                              numberOfLines = {1}>
                            {activity['title']}
                        </Text>
                        <Text style = {{color:'#FFFFFF',fontSize:14,textAlign:'center',width:windowWidth - 256.0 / 640 * windowWidth - 15}}>
                            {activity['sub_title']}
                        </Text>
                        <Text style = {{color:'#FFFFFF',fontSize:12,textAlign:'center',width:windowWidth - 256.0 / 640 * windowWidth - 15}}>
