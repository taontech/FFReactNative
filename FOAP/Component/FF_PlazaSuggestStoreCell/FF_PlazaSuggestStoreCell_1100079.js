    ...
    render:function(){
        ...
        return (
            <View style={{backgroundColor:'#FFFFFF'}}>
                ...
                <View style={{height:44,flexDirection:'row',width:windowWidth,backgroundColor:'#347834'}}>
            ...
            <TouchableHighlight
                ...
                <View style = {{width:300 / 640 * windowWidth, height:146.0 / 640 * windowWidth + 45.0,alignItems:'center'}}>
                    ...
                    <View style = {{flexDirection:'row'}}>
                        <Text style = {{color:'#994499',fontSize:14,top:5,width:146.0 / 640 * windowWidth,textAlign:'center'}} numberOfLines={0}>
                            {store['title']}
                        </Text>
                    </View>
