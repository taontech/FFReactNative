...
var weathercell = React.createClass({
    getInitialState: function() {
      this.executeQuery();
      const str = "正在获取天气数据。。。";
      const wp = "http://api.map.baidu.com/images/weather/day/qing.png";
      return{
        weatherstring: str,
        weatherpic:wp,
      }
    ...
    executeQuery: function () {
      var string = 'http://api.map.baidu.com/telematics/v3/weather?location=shanghai&output=json&ak=ABac42e4195202a9f98949e8513bcc9f';
      ...
      fetch(string)
        ...
        .then((responseData) => {
          console.log(responseData);
           this.setState({
            weatherstring: responseData['results'][0]['weather_data'][0]['date'],
